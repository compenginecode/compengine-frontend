...
define(function(require){
    ...
    App.module("Modals.MetadataReplacement.Controllers", function(Module, Application, Backbone) {
        ...
        Module.CategoryController = Module.AbstractController.extend({
            ...
            /** String literals **/
            STR_FIELD_ONLY_SPACES: "Please enter a valid category",

            CATEGORY_MUST_EXIST: "Category must be an existing one from the dropdown",
            ...
            bindToView: function(){
                this.__setupGenericAutocomplete("categories");

                this.view.registerEventHandler("keydown #" + this.view.getCategoriesInputField().attr("id"), this.__onAutosuggestInputKeyDown, this);
            },
            ...
            serialize: function(){
                return {
                    replacementId: this.view.getCategoriesInputField().data('id')
                };
            },
             ...
             */
            validate: function(){
                var $field = this.view.getCategoriesInputField();
                ...
                if ($field.val().length > 0 && "" === $field.val().trim()){
                    ...
                    $field.siblings(".error-label-small").text(this.CATEGORY_MUST_EXIST).show();
            ...
            __setupGenericAutocomplete: function(name) {
                var timeSeriesMetaDataCategoryUrl = App.apiEndpoint() + "/admin/categories/search";
                var $autoSuggest = this.view.getCategoriesInputField();
                var that = this;
                ...
                $autoSuggest.autocomplete({
                    ...
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: timeSeriesMetaDataCategoryUrl,
                            dataType: "json",
                            data: {
