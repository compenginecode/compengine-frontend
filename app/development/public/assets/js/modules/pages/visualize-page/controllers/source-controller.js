    ...
    App.module("VisualizePage.Controllers", function(Module, Application, Backbone) {
        ...
        Module.SourceController = Module.AbstractController.extend({
            ...
            initialize: function(view){
                ...
                this.listenTo(this.view, "set:source", this.setSource.bind(this));
            },

            bindToView: function(){
                this.__setupGenericAutocomplete("sources");

                this.view.registerEventHandler("keydown #" + this.view.getSourceInputField().attr("id"), this.__onAutosuggestInputKeyDown, this);
            },
            ...
            serialize: function(){
                return {
                    source: this.view.getSourceInputField().val()
                };
            },
             ...
             */
            validate: function(){
                var $field = this.view.getSourceInputField();
            ...
            __setupGenericAutocomplete: function(name) {
                ...
                var $autoSuggest = this.view.getSourceInputField();
                var that = this;
            ...
            __bindLocalEventListeners: function() {
                ...
                this.on("autoSuggestValueClicked:sources", function(value) {
            ...
            setSource: function(source) {
                ...
                this.view.getSourceInputField().val(source);
                this.view.showClearButton();
            }
