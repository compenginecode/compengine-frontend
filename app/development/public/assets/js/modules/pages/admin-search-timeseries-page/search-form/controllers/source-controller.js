    ...
    App.module("AdminSearchTimeseriesPage.SearchForm.Controllers", function(Module, Application, Backbone) {
        ...
        Module.SourceController = Module.AbstractController.extend({
            ...
            bindToView: function(){
                ...
                this.on("autoSuggestValueClicked:sources", function (e) {
                    that.selectedSourceId = e.id;
                });
            ...
            serialize: function(){
                return {
                    // source: this.view.getSourcesInputField().val()
                    source: this.view.getSourcesInputField().val().trim().length > 0 ? this.selectedSourceId : null
                };
            },
