...
define(function(require){
    ...
    var TagCardList = require("./tag-card-list");
    var SocialView = require("modules/common/views/social-view/social-view");

    /** Template **/
    var Template = require("text!./browse-tag-page.html");
        ...
        Module.View = App.Common.Views.SocialView.View.extend({
            ...
            subViews: {
                ...
                browseSelector: function () {
                    return new App.Browse.BrowseSelector({page: "tag"});
                }
            },
            ...
            initialize: function(options) {
                ...
                this.subViews.resultsList = function(){
                    return new Module.TagCardList({collection: options.resultsList});
                };
            },
