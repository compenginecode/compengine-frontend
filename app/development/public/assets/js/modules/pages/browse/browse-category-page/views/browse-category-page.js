...
define(function(require){
    ...
    var CategoryCardList = require("./category-card-list");
    var SocialView = require("modules/common/views/social-view/social-view");

    /** Template **/
    var Template = require("text!./browse-category-page.html");
        ...
        Module.View = App.Common.Views.SocialView.View.extend({
            ...
            subViews: {
                ...
                browseSelector: function () {
                    return new App.Browse.BrowseSelector({page: "category"});
                }
            },
            ...
            initialize: function(options) {
                ...
                this.subViews.resultsList = function() {
                    return new Module.CategoryCardList({collection: options.resultsList});
                };
            },
